...
const data: Array<Project> = [
    ...
    { title: "Giginator", link: "https://github.com/commenthropha/giginator", description: "Test", icons: [[SiTypescript, "3178C6"], [FaReact, "61DAFB"], [BiLogoPostgresql, "336791"]]},
    { title: "Press Start", link: null, description: "Test", icons: [[SiTypescript, "3178C6"], [TbBrandNextjs, "FFFFFF"], [GrGraphQl, "DE33A6"]]},
